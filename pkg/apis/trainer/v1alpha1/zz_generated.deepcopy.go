...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HPCMLPolicySource) DeepCopyInto(out *HPCMLPolicySource) {
	*out = *in
	if in.Tasks != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HPCMLPolicySource.
func (in *HPCMLPolicySource) DeepCopy() *HPCMLPolicySource {
	if in == nil {
		return nil
	}
	out := new(HPCMLPolicySource)
	in.DeepCopyInto(out)
	return out
}
